...
`pykrete.json` enables `strictTypeOps`); `select_then_unknown.pyk`
inherits the same config because they share a directory. See the
"Strict-mode caveat" subsection of `scripts/PROBES.md` before adding
new fixtures.
